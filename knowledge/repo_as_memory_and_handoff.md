...
- a STRATEGIC-PRIORITY / NORTH-STAR / founder-stance / trader-vs-coach / build-vs-trade-first decision, or a trading-identity refinement (scalp vs level, selectivity, the continuation read, AI-analysis guardrails, architecture-when-we-build) → **strategy_become_bioniq_first.md** (the center-of-gravity doc — read early)
