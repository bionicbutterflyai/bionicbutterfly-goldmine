...
## THE ANTI-PATTERN (what we refuse to be)
- Texting back and forth like this chat = a **boring chatbot**. Tedious, and it's not coaching.
- Dry trading copy to read + 10 multiple-choice questions = a **2002 website**. Boring, and it
  doesn't change behavior.

## THE PRODUCT (what actually makes us different)
- **Voice-first.** The coach *speaks back* — the voice from the data — not a wall of text. The
  experience is being coached out loud, not reading-and-quizzing.
- **A coach, not a consultant.** A consultant answers questions. A coach holds you accountable. The
  AI's job is to coach *behavior*, not just dispense information.
- **The accountability engine (the core mechanic):** your trades get evaluated. When you take a trade
  that isn't in your strategy, you have to **explain why — to a coach you don't want to disappoint.**
...
Jenny Craig, any of them. The *knowledge* is trivial and free: "count calories, walk 10,000 steps a
day" is a one-line search. People don't fail for lack of information — they succeed when they're
**accountable to someone they don't want to let down.** Trading is the identical shape: the strategy
is learnable in a day; the problem is executing it under pressure. The coach is the accountability,
...
you're left with a chatbot or a quiz site — the two things that bore people and don't work. The voice
+ the "explain your off-strategy trade" loop is the engine that changes trader behavior, which is the
