...
for lack of process); Student Zero proved it (same read, new process → green). Said to the student:
...
Student Zero's preference — separate panes over shared dual-axis; loses height but reads clean for the new eye).
