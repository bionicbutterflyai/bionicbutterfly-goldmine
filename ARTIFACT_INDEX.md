...
## knowledge/
- `tech_architecture_skeleton.md` | build, business-plan | PUBLIC | captured | MASTER system architecture (4 layers; live-vs-designed honest split). Chat-5 resolved: Fork-2 funnel-memory=BUILD (foyer→Supabase candidate_dossier→brain), datafeed v1 manual / v2 Massive.com free (ex-Polygon, 5/min, delayed, CME futures), human-in-the-loop gate, Web Speech default. Child flows next.
